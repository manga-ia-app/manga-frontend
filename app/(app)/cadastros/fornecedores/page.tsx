...
export default function FornecedoresPage() {
    ...
    { key: "category", header: "Categoria" },
    {
      ...
      render: (item) => (
        <Button
          ...
          onClick={(e) => {
            e.stopPropagation();
            router.push(`/cadastros/fornecedores/${item.id as string}`);
          }}
        >
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => getFornecedores({ search, page, pageSize: 20 }),
  });
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        action={
          <Button onClick={() => router.push("/cadastros/fornecedores/novo")}>
